...
Стратегия: облачное распределенное развёртывание с разделением frontend и backend, использованием Redis для кэширования сессий и Socket.IO для real-time.
Компоненты:
...
<img width="1263" height="455" alt="Component and Deployment" src="https://github.com/user-attachments/assets/16f7d7ba-b7ec-4e78-a9b2-7b1188ef4bbc" />
...
## Вывод 
В ходе лабораторной работы была проведена проектная декомпозиция архитектуры QuizNest (To Be) и обратный инжиниринг текущей реализации (As Is).
Сравнительный анализ выявил разрывы между идеальной и реальной архитектурой, обусловленные:
- приоритетом фич над инфраструктурой,
- техническим долгом ранних этапов.
  
Предложенные меры рефакторинга устраняют эти разрывы.Реализация данных улучшений позволит приблизить архитектуру QuizNest к эталонной, повысив масштабируемость, отказоустойчивость и удовлетворённость пользователей.
